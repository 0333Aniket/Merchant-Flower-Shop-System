    ...
    <div class="container">
		...
		<div class="about-main">
			<div class="row">
				...
				<div class="col-lg-6">
					<h2>About BLOOSOM FLOWERS</h2>
					<p> BLOOSOM FLOWERS is an E-commerce market place for B2B Buying & Selling of Indian and imported flowers & leaf’s.
					  BLOOSOM FLOWERS is operated through mobile application, itis available both on Android and IOS. Buyers across India 
					 can buy through  BLOOSOM FLOWERS Buyer App and one can sell through  BLOOSOM FLOWERS Seller App.
 BLOOSOM FLOWERS is a one stop shop to buy all kinds of Indian flowers, imported flowers and leafs in Bulk.
 By using  BLOOSOM FLOWERS Buyerapp the Re-sellers, Decorators, Wedding planners and Event companies can buy directly from 
 the growers and whole sellers from any part of the country.By using  BLOOSOM FLOWERS Seller App the growers, 
whole sellers, re-sellers, can sell directly to the buyers across India without any hassle, with the support of  BLOOSOM FLOWERS team.</p>
